...
public class ShipAI : ShipSystem2
{
    ...
    protected Vector3 wingmanPosition;
    ...
    protected bool pathFind;
    public void PathFinder(Vector3 TargetVector)
    {
        RaycastHit hit;
    ...
    public void GetNodes(Vector3 StartPosition, Vector3 TargetPosition)
    {
        Vector3 hitPos = new Vector3();
    ...
    public GameObject[] FindAvailableNodes(GameObject[] Nodes, Vector3 StartPosition)
    {
        //Create a new list.
    ...
    public int FindShortestDistance(GameObject[] Nodes, Vector3 startPosition, Vector3 goalPosition)
    {
    ...
    public Vector3 HandleCollisionDetection(Vector3 input)
    {
    ...
    public float CheckCollisionOnAxis(Vector3 direction, float directionInput)
    {
