Shader "WaterTesselated"
{
    Properties
    {
        ...
        _NormalmapStrength ("Normalmap strength", Range(0,1)) = 1
        ...
        [Header(Sun specular)]
        [HDR]
        _SunSpecularPower ("Power", float) = 100
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float _SunSpecularPower;
            ...
            float4 Fragment(Varyings input) : SV_Target
            {
                ...
                normalWS = lerp(input.normalWS, normalWS, _NormalmapStrength);
                ...
                baseColor = lerp(_DeepColor, baseColor, transmittance * max(0.5f, shadowMask));
                ...
                sunSpecularMask = sunSpecularMask * mainLight.shadowAttenuation * _SunSpecularPower;
